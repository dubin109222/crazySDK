//
//  CS_ShareMoreInfomationController.swift
//  CrazySnake
//
...
class CS_ShareMoreInfomationController: CS_BaseAlertController {

    private var page = 1
    private var dataSource = [CS_ShareFriendModel]()
    ...
    lazy var dateLabel: UILabel = {
        ...
        label.text = "crazy_str_friend".ls_localized
        return label
    }()
    ...
    lazy var amountLabel: UILabel = {
        ...
        label.ls_set(.ls_white(), .ls_JostRomanFont(12))
        label.textAlignment = .center
        label.text = "crazy_str_shared_today".ls_localized
        return label
    }()
    ...
    lazy var statusLabel: UILabel = {
        ...
        label.ls_set(.ls_white(), .ls_JostRomanFont(12))
        label.textAlignment = .center
        label.text = "crazy_str_total_shared".ls_localized
        return label
    }()
    ...
    lazy var tableView: UITableView = {
        ...
        view.rowHeight = 120
        view.register(CS_ShareMoreInfomationCell.self, forCellReuseIdentifier: NSStringFromClass(CS_ShareMoreInfomationCell.self))
...
//MARK: TableView
extension CS_ShareMoreInfomationController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: NSStringFromClass(CS_ShareMoreInfomationCell.self)) as! CS_ShareMoreInfomationCell
...
//MARK: request
extension CS_ShareMoreInfomationController {
    func requstList(){
        ...
        CSNetworkManager.shared.getShareFriends("\(address)", page: "\(page)", size: "20") { resp in
            LSHUD.hide()
            var hasMore = false
...
extension CS_ShareMoreInfomationController {
    ...
    private func setupView() {
        ...
        titleLabel.text = "crazy_str_detailed_information".ls_localized
