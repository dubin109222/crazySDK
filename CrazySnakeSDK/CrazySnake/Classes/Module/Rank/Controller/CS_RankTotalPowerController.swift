//
//  CS_RankTotalPowerController.swift
//  CrazySnake
//
...
class CS_RankTotalPowerController: CS_BaseEmptyController {
...
//MARK: TableView
extension CS_RankTotalPowerController: UITableViewDelegate, UITableViewDataSource {
...
//MARK: request
extension CS_RankTotalPowerController {
    func requstList(){
...
extension CS_RankTotalPowerController: JXSegmentedListContainerViewListDelegate {
