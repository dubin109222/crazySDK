//
//  CS_RankStakeNFTController.swift
//  CrazySnake
//
...
class CS_RankStakeNFTController: CS_BaseEmptyController {
    ...
    lazy var getLabel: UILabel = {
        ...
        label.ls_set(.ls_text_gray(), .ls_JostRomanFont(14))
        label.textAlignment = .center
        label.text = "crazy_str_number_of_nfts".ls_localized
        return label
    }()
    ...
    lazy var tableView: UITableView = {
        ...
        view.rowHeight = 50
        view.register(CS_RankTotalPowerCell.self, forCellReuseIdentifier: NSStringFromClass(CS_RankTotalPowerCell.self))
    ...
    lazy var rankView: CS_RankTotalPowerView = {
        ...
        view.numberView.iconView.image = UIImage.ls_bundle("rank_icon_number_nft2@2x")
        view.isHidden = true
        return view
    }()
}
...
//MARK: TableView
extension CS_RankStakeNFTController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: NSStringFromClass(CS_RankTotalPowerCell.self)) as! CS_RankTotalPowerCell
        cell.rankView.numberView.iconView.image = UIImage.ls_bundle("rank_icon_number_nft2@2x")
...
//MARK: request
extension CS_RankStakeNFTController {
    func requstList(){
...
extension CS_RankStakeNFTController: JXSegmentedListContainerViewListDelegate {
